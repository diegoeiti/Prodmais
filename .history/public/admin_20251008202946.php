                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="programa_umc" class="form-label">Programa de Pós-Graduação UMC (Opcional)</label>
                                        <select class="form-select" id="programa_umc" name="programa_umc">
                                            <option value="">Detectar automaticamente</option>
                                            <option value="mestrado_direito">Mestrado em Direito</option>
                                            <option value="mestrado_educacao">Mestrado em Educação</option>
                                            <option value="mestrado_engenharia_sistemas">Mestrado em Engenharia de Sistemas</option>
                                            <option value="mestrado_psicologia">Mestrado em Psicologia</option>
                                        </select>
                                    </div>
